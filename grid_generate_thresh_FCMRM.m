function [ PwJ_MLE,PwJ_GRE  ,  PbJ_MLE,PbJ_GRE] = grid_generate_FCMRM( image_names,images_keywords,number_of_clusters,fuzzy_membership,number_of_words,threshold )
