function [ features_vector ] = training( image_names, L, D )
...
features_vector = zeros(24*L,D+1); % we add one to append the image the region belongs to
...
for i = 1 : L
    ...
    features_vector(24*(i-1)+1:i*24,:) = tmp;
