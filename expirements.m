...
% [ memberships_250_15, centroids_250_15 ] = clusterRegions( features_vector(:, 1:15), 250, 1.5 );
% [ memberships_250_175, centroids_250_175 ] = clusterRegions( features_vector(:, 1:15), 250, 1.75 );
% [ memberships_250_20, centroids_250_20 ] = clusterRegions( features_vector(:, 1:15), 250, 2.0 );
% 
% [ PwJ_MLE_250_15, PwJ_GRE_250_15, PbJ_MLE_250_15, PbJ_GRE_250_15 ] = generateFCMRM( image_names, images_keywords, 250, memberships_250_15, number_of_words );
% [ PwJ_MLE_250_175, PwJ_GRE_250_175, PbJ_MLE_250_175, PbJ_GRE_250_175 ] = generateFCMRM( image_names, images_keywords, 250, memberships_250_175, number_of_words );
% [ PwJ_MLE_250_20, PwJ_GRE_250_20, PbJ_MLE_250_20, PbJ_GRE_250_20 ] = generateFCMRM( image_names, images_keywords, 250, memberships_250_20, number_of_words );
